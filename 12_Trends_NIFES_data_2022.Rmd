...
leaflet() %>%
  addTiles() %>%
  addMarkers(lng = df_nifes_stations$LONGITUDE, lat = df_nifes_stations$LATITUDE,
             popup = df_nifes_stations$STATION_CODE)

```

### Add station names to 
```{r}
