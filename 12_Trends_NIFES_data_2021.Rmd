...
if (revised_data){
  ...
  df_median <- readRDS("Data/11_df_median (2021) rev 19.02.2021.rds") %>%
...
debugonce(model_from_medians)
debugonce(plot_models_one_station)
...
if (overwrite & !revised_data){
  ...
  saveRDS(nifes_regression, "Data/12_nifes_regression (2021) rev 19.02.2021.rds")
  write.csv(nifes_regression, "Data/12_nifes_regression (2021) rev 19.02.2021.csv", quote = FALSE, row.names = FALSE)
}
