...
fn <- "Data_export/GaduMor_2021data_Norw_Sea_ver01"
...
if (FALSE){
  ...
  # Read back
  df_indicator2 <- read.csv(file = "Data_export/2021 report Norwegian Sea/GaduMor_2021data_Norw_Sea_ver01.csv")
...
df_compare %>%
  filter((KLASSE_prev != KLASSE) | (EQS_prev != EQS) | (Mattrygghet_prev != Mattrygghet)) %>%
  openxlsx::write.xlsx(paste0(fn, "_differences.xlsx"))
